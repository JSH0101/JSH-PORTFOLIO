...
>
> - 개발기간 : 2024.11.26-12.02
> - 핵심 역할 : 팀원, Fulfillment 가상 서비스 환경 설계 및 OpenManipulator 연동 구현, YOLO 인식 결과를 활용한 로봇팔 동작 제어 및 박스 이동 알고리즘 설계
> - Language : python3
...
>
> - 개발기간 : 2024.11.26-12.02
> - 핵심 역할 : 팀원, SLAM 기반 다중이용시설 로봇 주행 환경 설계 및 장애물 인식 모델 개발, 라이다와 카메라 센서 퓨전을 활용한 데이터 구축 기획, 미탐지 공간 확인 알고리즘 구현
> - Language : python3, C++
> - Skill : ROS2, Nav2, Visual SLAM, Lidar SLAM, Visual Odometry, Sensor Fusion, ORB 기반 객체 추적
>
...
>
> - 개발기간 : 2024.11.26-12.02
> - 핵심 역할 : 팀원, SLAM 기반 로봇 주행 환경 설계 및 장애물 인식 모델 개발, 라이다와 카메라 센서 퓨전을 활용한 데이터 구축 기획, 미탐지 공간 확인 알고리즘 구현
> - Language : python3, C++
> - Skill : ROS2, Nav2, Visual SLAM, Lidar SLAM, Visual Odometry, Sensor Fusion, ORB 기반 객체 추적
>
