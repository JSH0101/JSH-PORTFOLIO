...
언제나 밝은 **웃음**과 빛나는 **열정**으로 팀에 어울리면서, 팀의 성공에 기여하는 팀원이 되겠습니다! 
...
> - PLC 자동화 제어 설계 교육 이수 2024.07.15 ~ 2024.07.19
...
>
> - 프로젝트 요약 : 메뉴를 주분하는 테이블 키오스크, 메뉴, 로봇 위치 실시간 확인 및 로봇 조작하는 주방 gui, 로봇 위 달린 디스플레이에 띄울 로봇 GUI 시뮬레이션 구현
